...
in rec {
  binaries = pkgs.stdenv.mkDerivation {
    ...
    installPhase = ''
      ...
      cp ${ic.binaries}/bin/{replica,ic-admin,ic-prep,ic-starter,ic-https-outcalls-adapter,ic-nns-init,canister_sandbox,compiler_sandbox,sandbox_launcher} $out/bin/

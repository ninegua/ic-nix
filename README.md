...
3. Use pre-built `aarch64` binaries by getting it from the [20220711](https://github.com/ninegua/ic-nix/releases/tag/2022711) release. These were built offline and manually uploaded.

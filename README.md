...
3. Use pre-built `aarch64` binaries by getting it from the [20230704](https://github.com/ninegua/ic-nix/releases/tag/20230704) release. These were built offline and manually uploaded.
